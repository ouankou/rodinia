...
//         scale = 0.8f * | epsilon * y[i] / [err * (xmax - x[0])] | ^ 1/7     //
//     The scale factor is further constrained 0.125f < scale < 4.0.           //
...
static void embedded_fehlberg_7_8(	fp timeinst,
															fp h,
															fp* initvalu,
															fp* finavalu,
															fp* error,
	...
	static const fp c_1_11 = 41.0f / 840.0f;
	static const fp c6 = 34.0f / 105.0f;
	static const fp c_7_8= 9.0f / 35.0f;
	static const fp c_9_10 = 9.0f / 280.0f;

	static const fp a2 = 2.0f / 27.0f;
	static const fp a3 = 1.0f / 9.0f;
	static const fp a4 = 1.0f / 6.0f;
	static const fp a5 = 5.0f / 12.0f;
	static const fp a6 = 1.0f / 2.0f;
	static const fp a7 = 5.0f / 6.0f;
	static const fp a8 = 1.0f / 6.0f;
	static const fp a9 = 2.0f / 3.0f;
	static const fp a10 = 1.0f / 3.0f;

	static const fp b31 = 1.0f / 36.0f;
	static const fp b32 = 3.0f / 36.0f;
	static const fp b41 = 1.0f / 24.0f;
	static const fp b43 = 3.0f / 24.0f;
	static const fp b51 = 20.0f / 48.0f;
	static const fp b53 = -75.0f / 48.0f;
	static const fp b54 = 75.0f / 48.0f;
	static const fp b61 = 1.0f / 20.0f;
	static const fp b64 = 5.0f / 20.0f;
	static const fp b65 = 4.0f / 20.0f;
	static const fp b71 = -25.0f / 108.0f;
	static const fp b74 =  125.0f / 108.0f;
	static const fp b75 = -260.0f / 108.0f;
	static const fp b76 =  250.0f / 108.0f;
	static const fp b81 = 31.0f/300.0f;
	static const fp b85 = 61.0f/225.0f;
	static const fp b86 = -2.0f/9.0f;
	static const fp b87 = 13.0f/900.0f;
	static const fp b91 = 2.0f;
	static const fp b94 = -53.0f/6.0f;
	static const fp b95 = 704.0f / 45.0f;
	static const fp b96 = -107.0f / 9.0f;
	static const fp b97 = 67.0f / 90.0f;
	static const fp b98 = 3.0f;
	static const fp b10_1 = -91.0f / 108.0f;
	static const fp b10_4 = 23.0f / 108.0f;
	static const fp b10_5 = -976.0f / 135.0f;
	static const fp b10_6 = 311.0f / 54.0f;
	static const fp b10_7 = -19.0f / 60.0f;
	static const fp b10_8 = 17.0f / 6.0f;
	static const fp b10_9 = -1.0f / 12.0f;
	static const fp b11_1 = 2383.0f / 4100.0f;
	static const fp b11_4 = -341.0f / 164.0f;
	static const fp b11_5 = 4496.0f / 1025.0f;
	static const fp b11_6 = -301.0f / 82.0f;
	static const fp b11_7 = 2133.0f / 4100.0f;
	static const fp b11_8 = 45.0f / 82.0f;
	static const fp b11_9 = 45.0f / 164.0f;
	static const fp b11_10 = 18.0f / 41.0f;
	static const fp b12_1 = 3.0f / 205.0f;
	static const fp b12_6 = - 6.0f / 41.0f;
	static const fp b12_7 = - 3.0f / 205.0f;
	static const fp b12_8 = - 3.0f / 41.0f;
	static const fp b12_9 = 3.0f / 41.0f;
	static const fp b12_10 = 6.0f / 41.0f;
	static const fp b13_1 = -1777.0f / 4100.0f;
	static const fp b13_4 = -341.0f / 164.0f;
	static const fp b13_5 = 4496.0f / 1025.0f;
	static const fp b13_6 = -289.0f / 82.0f;
	static const fp b13_7 = 2193.0f / 4100.0f;
	static const fp b13_8 = 51.0f / 82.0f;
	static const fp b13_9 = 33.0f / 164.0f;
	static const fp b13_10 = 12.0f / 41.0f;

	static const fp err_factor  = -41.0f / 840.0f;

	fp h2_7 = a2 * h;

	fp timeinst_temp;
	fp* initvalu_temp = workspace;
	fp* finavalu_temp_data = workspace + EQUATIONS;
	fp* finavalu_temp[FEHLBERG_STAGES];

	int i;

	for (i= 0; i<FEHLBERG_STAGES; i++){
		finavalu_temp[i]= finavalu_temp_data + (size_t)i * EQUATIONS;
	}
	...
	for(i=0; i<EQUATIONS; i++){
		error[i] = fabsf(err_factor * (finavalu_temp[0][i] + finavalu_temp[10][i] - finavalu_temp[11][i] - finavalu_temp[12][i]));
		// printf("Error[%d] = %f\n", i, error[i]);
	}
